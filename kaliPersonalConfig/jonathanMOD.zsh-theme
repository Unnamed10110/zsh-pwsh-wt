...
${PR_WHITE}${PR_ULCORNER}${PR_HBAR}${PR_GREY}(\
${PR_GREEN}%${PR_PWDLEN}<...<%~%<<\
${PR_GREY})$(virtualenv_prompt_info)$(ruby_prompt_info)${PR_WHITE}${PR_HBAR}${PR_HBAR}${(e)PR_FILLBAR}${PR_HBAR}${PR_GREY}(\
${PR_WHITE}%(!.%SROOT%s.%n)${PR_GREY}@${PR_GREEN}%m:%l\
${PR_GREY})${PR_WHITE}${PR_HBAR}${PR_URCORNER}\

${PR_WHITE}${PR_LLCORNER}${PR_BLUE}${PR_HBAR}(\
${PR_WHITE}%D{%H:%M:%S}\
...
(${PR_WHITE}%D{%a,%b%d}${PR_BLUE})${PR_HBAR}${PR_CYAN}${PR_LRCORNER}${PR_NO_COLOUR}'
